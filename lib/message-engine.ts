 ...
 *
 * The engine processes incoming RTC and/or RTM messages and manages the state of transcribed text.
 ...
 *
 * @property rtcEngine - RTC engine instance for real-time communication (optional)
 * @property rtmEngine - RTM engine instance for signaling messages (optional)
...
export class MessageEngine {
  ...
  private _listenRtmEvents() {
    ...
    // RTM message handler
    this._rtmMessageHandler = (event: any) => {
